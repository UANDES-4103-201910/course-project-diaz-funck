...
ActiveRecord::Schema.define(version: 2019_04_10_194022) do
  ...
  create_table "blacklisted_users", force: :cascade do |t|
    ...
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.index ["blacklist_status_id"], name: "index_blacklisted_users_on_blacklist_status_id"
    t.index ["user_id"], name: "index_blacklisted_users_on_user_id"
  end
